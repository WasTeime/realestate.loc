...
$config['backends'] = [
    [
        'name' => 'default',
        'adapter' => 'local',
        'baseUrl' => '/uploads/global/', // Относительные ссылки
        'root' => dirname(__DIR__) . '/uploads/global/',
        'chmodFiles' => 0777,
        'chmodFolders' => 0755,
    ...
    [
        'name' => 'mail',
        'adapter' => 'local',
        'root' => dirname(__DIR__, 2) . '/common/mail/',
        'chmodFiles' => 0777,
        'chmodFolders' => 0755,
        'filesystemEncoding' => 'UTF-8',
    ]
...
$config['resourceTypes'] = [
    [
        ...
        'directory' => 'files',
        'maxSize' => 0,
        'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,webp,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,webp,webm,xls,xlsx,zip',
        'deniedExtensions' => '',
        'backend' => $backend
    ],
    [
    ...
    [
        ...
        'directory' => 'video',
        'maxSize' => 0,
        'allowedExtensions' => 'm4a,mp4,webm',
        'deniedExtensions' => '',
        'backend' => $backend
    ]
];
