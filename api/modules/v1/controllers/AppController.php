 ...
 */
#[OA\Info(version: '1.0', title: 'Application API')]
#[OA\Server(url: '/api/v1', description: 'current')]
#[OA\SecurityScheme(
...
JS
     ...
     * {@inheritdoc}
     *
     * Обработка ключа идемпотентности
     */
    ...
    #[OA\Schema(schema: 'Pagination', properties: [
        new OA\Property(property: 'totalCount', type: 'integer', example: 1),
        new OA\Property(property: 'page', type: 'integer', example: 1),
        new OA\Property(property: 'pageSize', type: 'integer', example: 20),
        new OA\Property(property: 'pageCount', type: 'integer', example: 1)
    ])]
