...
#[JsonSuccess(content: [
    new OA\Property(property: 'service_data', description: 'Введенные ранее данные', type: 'object')
])]
#[JsonError(description: 'ERROR no data', content: [
    new OA\Property(property: 'service_data:error', type:     'string', example:  'No service data')
])]
