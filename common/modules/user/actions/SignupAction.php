...
#[JsonError(
    ...
    content: [
        new OA\Property(
            ...
            items:    new OA\Items(type: 'string', example: 'Пользователь с таким логином уже зарегистрирован')
        ),
        new OA\Property(
            property: 'email', type: 'array',
            items:    new OA\Items(type: 'string', example: 'Такой Email уже зарегистрирован')
        ),
        new OA\Property(
            property: 'rules_accepted', type: 'array',
            items:    new OA\Items(type: 'string', example: 'Необходимо согласиться с правилами')
        )
    ]
)]
