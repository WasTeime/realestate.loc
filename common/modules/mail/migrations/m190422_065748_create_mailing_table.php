...
class m190422_065748_create_mailing_table extends Migration
{
    ...
    final public function safeUp(): void
    {
        ...
        $this->insert('{{%mailing}}', [
            'name' => 'email-confirm',
            'mailing_type' => MailingType::Single->value,
            'mail_template_id' => 1,
        ...
        $this->insert('{{%mailing}}', [
            'name' => 'cheater-notify',
            'mailing_type' => MailingType::Multiple->value,
            'mail_template_id' => 4,
            'mail_subject' => 'Обнаружен потенциальный читер',
            'comment' => 'Уведомление администрации сайта',
        ]);
    }
