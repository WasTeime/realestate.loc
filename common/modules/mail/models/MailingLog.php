 ...
 * @property int             $mailing_id      [int] ID рассылки
...
class MailingLog extends AppActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            ['app_type', 'required'],
            [['mailing_id', 'user_id', 'date', 'status', 'app_type', 'mailing_log_id'], 'integer'],
            LogStatus::validator('status'),
            AppType::validator('app_type'),
            [['mailing_subject', 'description'], 'string', 'max' => 255],
    ...
    final public function getMailing(): ActiveQuery
    {
