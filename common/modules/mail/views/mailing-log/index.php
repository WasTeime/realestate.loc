...
use common\modules\mail\{enums\LogStatus, Mail, models\Mailing, models\MailingLog};
...
<div class="mailing-log-index">
    ...
    <?= SortableGridView::widget([
        ...
        'columns' => [
            ...
            ColumnSelect2::widget([
                'attr' => 'mailing_id',
                'items' => Mailing::find()->select(['name', 'id'])->indexBy('id')->column(),
                'editable' => false,
                'width' => 120
            ]),
            ColumnSelect2::widget(
                ...
                ['value' => static fn ($model) => $model->mailing_subject]
            ),
