...
use common\modules\mail\{enums\LogStatus, Mail, models\Mailing, models\MailingLog, models\MailTemplateSearch};
...
<div class="mailing-log-index">
    ...
    <?= SortableGridView::widget([
        ...
        'columns' => [
            ...
            ColumnSelect2::widget(['attr' => 'mailing_id', 'items' => Mailing::findList(), 'editable' => false]),
            ColumnSelect2::widget([
                'attr' => 'mailing_subject',
                'items' => Mailing::find()->select(['mail_subject'])->indexBy('mail_subject')->column(),
                'editable' => false
            ]),
