...
class UserFileHelper extends FileHelper
{
     ...
     */
    public static function deleteFile(string $filename, string $app = 'admin', string $category = 'saved'): void
    {
     ...
     * @param string $category Категория json файла.
     */
    public static function fileExists(string $filename, string $app = 'admin', string $category = 'saved'): bool
    {
     ...
     */
    private static function _getRuntimePath(string $app = 'admin'): string
    {
