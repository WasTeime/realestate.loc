...
abstract class CKEditor5 extends InputWidget
{
     ...
     * Url to image upload
     */
    public string $uploadUrl = '/ckfinder/connector.php?command=QuickUpload&type=Images&responseType=json';
...
CSS
    ...
    protected function registerEditorJS(): void
    {
        ...
        if (empty($this->clientOptions['ckfinder']) && !empty($this->uploadUrl)) {
            ...
            $this->clientOptions['ckfinder']['options']['connectorPath'] = '/ckfinder/connector.php';
        }
